...
server.post(
    ...
    function (req, res, next) {
        ...
        if (Object.keys(shippingFormErrors).length > 0) {
            ...
            var kamalCustom = form.shippingAddress.addressFields.kamalCustom.value;
            dw.system.Logger.warn('kamalCustom  ==  '+kamalCustom);
            result.address = {
                ...
                kamalCustom: form.shippingAddress.addressFields.kamalCustom.value
            };
